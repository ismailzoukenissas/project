...
DB_PATH    = f"{BASE}/data/airline.duckdb"
OUTPUT     = f"{BASE}/rapport/dictionnaire_donnees.md"

con = duckdb.connect(DB_PATH)

# ─────────────────────────────────────────────
# Dictionnaire manuel des colonnes Silver
# ─────────────────────────────────────────────
silver = [
...
# ─────────────────────────────────────────────
# Dictionnaire manuel des colonnes Gold
# ─────────────────────────────────────────────
gold = {
    "mart_merger_impact": [
...
# ─────────────────────────────────────────────
lines = []
lines.append("# Dictionnaire de données — Airline Performance 2009-2018\n\n")

# Silver
lines.append("## Couche Silver — `stg_flights` + `int_flights_enriched`\n\n")
lines.append("| Colonne | Type | Description | Exemple | Notes |\n")
lines.append("|---|---|---|---|---|\n")
for row in silver:
...
# Gold
lines.append("## Couche Gold\n\n")
for mart_name, cols in gold.items():
...
print("="*60)
print(f"✅  Dictionnaire généré : {OUTPUT}")
print("="*60)